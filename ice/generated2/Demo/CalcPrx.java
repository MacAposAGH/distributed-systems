...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx {
    ...
    default float avg(long[] numbers)
            throws NoInput {
        return avg(numbers, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float avg(long[] numbers, java.util.Map<String, String> context)
            throws NoInput {
        try {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] numbers) {
        return _iceI_avgAsync(numbers, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] numbers, java.util.Map<String, String> context) {
     ...
     * @hidden
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_avgAsync(long[] iceP_numbers, java.util.Map<String, String> context, boolean sync) {
